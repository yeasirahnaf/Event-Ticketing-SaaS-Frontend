...
export default function AdminLoginPage() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 min-h-screen flex flex-col justify-center items-center bg-slate-50 py-12 sm:px-6 lg:px-8 font-sans">
